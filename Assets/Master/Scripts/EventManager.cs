...
{
    public static EventManager Instance { get; private set; } // Singleton instance for global access
    ...
    public static event Action OnAniiActivate;
    void Awake()
    {
    ...
    {
        float roll = UnityEngine.Random.Range(0f, 1f); // Generate a random value between 0 and 1
    ...
    private void ActivateBonus()
    {
        ...
        if (aniiFloatingText != null)
        {
            ...
            floatingText.GetComponentInChildren<TMP_Text>().text = "Anii!"; // Set initial message
            timerTab.GetComponent<TimerSystem>().setTime = boostDuration;
